...
const CANDY_MODEL  = "meta/llama-4-maverick-17b-128e-instruct-maas"; // Vertex AI (free, multimodal)
const PIPES_MODEL  = "gemini-3.1-flash-lite-preview"; // Vertex AI native (multimodal — team lead)
const MAOMAI_MODEL = "meta/llama-4-maverick-17b-128e-instruct-maas"; // Vertex AI (free, 128 experts — codegen)
...
// Always create a new buildId — never overwrite past builds
const buildId = `ws_${Date.now()}_${slug}`;
